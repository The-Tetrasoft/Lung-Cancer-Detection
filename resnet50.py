...
def main(model_name):
    ...
    test_dataset = CustomAugmentationDataset(test_subset, class_names, {}, is_train=False)
    ...
    sample_images_dir = './Filtered_CXR_Dataset'
    sample_images = {
    ...
    # Save some augmented samples periodically
    sample_images_dir = os.path.join(DATA_ROOT, 'Training_set')
    augmented_samples_dir = os.path.join(MODELS_OUTPUT_DIR, 'augmented_samples')
    ...
    for class_name in class_names:
        ...
        if os.path.exists(class_dir):
            ...
            if images:
                ...
                save_augmented_samples(
                    image_path,
                    os.path.join(augmented_samples_dir, class_name),
                    class_name,
